...
ALB_VALUES_FILE = os.path.join(PROJECT_ROOT, "zen-gitops/k8s/ingress/alb-controller-values.yaml")
...
ingress_file = os.path.join(PROJECT_ROOT, "zen-gitops/argocd/install/argocd-ingress.yaml")
