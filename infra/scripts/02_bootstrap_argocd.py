...
print("============================================")
print()
print("  This script registers your zen-gitops repo in ArgoCD,")
...
print("    2. GitOps repo URL     - HTTPS URL of your zen-gitops fork")
print("    3. GitHub username     - your GitHub account name")
print("    4. GitHub token        - PAT with read access to zen-gitops (input hidden)")
print()
...
GITHUB_USERNAME = prompt("GITHUB_USERNAME", "Your GitHub username (used for ArgoCD repo authentication)",
...
if apply_result.returncode != 0:
    die("kubectl apply of zen-gitops-repo secret failed.")
